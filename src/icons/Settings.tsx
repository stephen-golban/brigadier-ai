 ...
 * `dist/es/components/Icon/svg/Settings.js`. Licence in `src/icons/LICENSE.md`.
 *
...
const Settings = (props: SVGProps<SVGSVGElement>) => (
  <svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" data-icon="settings" aria-hidden="true" {...props}>
