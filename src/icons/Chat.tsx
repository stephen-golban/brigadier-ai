 ...
 * `dist/es/components/Icon/svg/Chat.js`. Licence in `src/icons/LICENSE.md`.
 *
...
const Chat = (props: SVGProps<SVGSVGElement>) => (
  <svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" data-icon="chat" aria-hidden="true" {...props}>
