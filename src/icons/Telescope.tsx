 ...
 * `dist/es/components/Icon/svg/Telescope.js`. Licence in `src/icons/LICENSE.md`.
 *
...
const Telescope = (props: SVGProps<SVGSVGElement>) => (
  <svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" data-icon="telescope" aria-hidden="true" {...props}>
    <path fillRule="evenodd" clipRule="evenodd" d="M12.47 15.652a1 1 0 0 1 1.378.318l2.5 4a1 1 0 1 1-1.696 1.06l-2.5-4a1 1 0 0 1 .318-1.378Z" />
    ...
    <path fillRule="evenodd" clipRule="evenodd" d="M12 12.5a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3ZM8.5 14a3.5 3.5 0 1 1 7 0 3.5 3.5 0 0 1-7 0Z" />
  </svg>
);
