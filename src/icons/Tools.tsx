 ...
 * `dist/es/components/Icon/svg/Tools.js`. Licence in `src/icons/LICENSE.md`.
 *
...
const Tools = (props: SVGProps<SVGSVGElement>) => (
  <svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" data-icon="tools" aria-hidden="true" {...props}>
