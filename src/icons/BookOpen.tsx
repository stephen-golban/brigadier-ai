 ...
 * `dist/es/components/Icon/svg/BookOpen.js`. Licence in `src/icons/LICENSE.md`.
 *
...
const BookOpen = (props: SVGProps<SVGSVGElement>) => (
  <svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" data-icon="book-open" aria-hidden="true" {...props}>
