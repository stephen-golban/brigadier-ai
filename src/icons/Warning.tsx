 ...
 * `dist/es/components/Icon/svg/Warning.js`. Licence in `src/icons/LICENSE.md`.
 *
...
const Warning = (props: SVGProps<SVGSVGElement>) => (
  <svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" data-icon="warning" aria-hidden="true" {...props}>
