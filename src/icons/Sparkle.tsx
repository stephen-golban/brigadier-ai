 ...
 * `dist/es/components/Icon/svg/Sparkle.js`. Licence in `src/icons/LICENSE.md`.
 *
...
const Sparkle = (props: SVGProps<SVGSVGElement>) => (
  <svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" data-icon="sparkle" aria-hidden="true" {...props}>
