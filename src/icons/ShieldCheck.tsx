 ...
 * `dist/es/components/Icon/svg/ShieldCheck.js`. Licence in `src/icons/LICENSE.md`.
 *
...
const ShieldCheck = (props: SVGProps<SVGSVGElement>) => (
  <svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" data-icon="shield-check" aria-hidden="true" {...props}>
