...
const fake = vi.hoisted(() => ({seq: 1, deltas: 0, subscribers: new Set<() => void>(), history: vi.fn(), turns: vi.fn(async () => [] as ChatTurn[])}));
...
afterEach(() => {
  cleanup();vi.useRealTimers();fake.history.mockReset();fake.seq=1;fake.deltas=0;
